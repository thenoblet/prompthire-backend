...
class Settings(BaseSettings):
    ...
    Attributes:
        ...
        cors_origins: Comma-separated list of allowed CORS origins. An empty
            string disables CORS. Parsed into a list via ``cors_origins_list``.
        ...
        litellm_timeout_seconds: Per-request timeout forwarded to litellm.
